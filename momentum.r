...
# load("sector.rdata")
# data<-indexdata.csv/100
# data<-data[,-11]
# m.from=1
# m.to=1
# m.window=1
# test.study<-mom_study(data,m.from,m.to,m.window)
# round(test.study$rank.return.mean*100,2)
# round(test.study$ac.return.mean*100,2)
# round(test.study$Summary*100,2)